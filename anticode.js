...
const translations = {
    ...
    ja: {
        ...
        "type-notice": " (告知)", "type-secret": " (非公開)", "type-open": " (公開)", "type-qna": " (Q&A)", "type-general": "一般", "chat-page-all": "全チャンネル (編集不可)", "chat-page-empty": "このページにはチャンネルはありません。", "chat-discovery-none": "検索結果なし", "chat-owned-none": "作成したチャットルームはありません。", "chat-personal-none": "作成したカテゴリーはありません。",
