...
const translations = {
    ...
    en: {
        ...
        "type-notice": " (Notice)", "type-secret": " (Private)", "type-open": " (Public)", "type-qna": " (Q&A)", "type-general": "General", "chat-page-all": "All Channels (View Only)", "chat-page-empty": "No channels on this page.", "chat-discovery-none": "No results found", "chat-owned-none": "No chat rooms created.", "chat-personal-none": "No personal categories found.",
    ...
    ja: {
        ...
        "type-notice": " (告知)", "type-secret": " (非公開)", "type-open": " (公開)", "type-qna": " (Q&A)", "type-general": "一般",
        "cat-notice": "📢 お知らせ", "cat-chat": "💬 チャットルーム", "cat-karaoke": "🎤 カラオケ", "cat-voice": "📞 ボイストーク", "cat-game": "🎮 ゲームルーム", "chat-page-all": "全チャンネル (編集不可)", "chat-page-empty": "このページにはチャンネルはありません。", "chat-discovery-none": "検索結果なし", "chat-owned-none": "作成したチャットルームはありません。", "chat-personal-none": "作成したカテゴリーはありません。",
